<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  while ($row = $res->fetch_object()) {
    ...
    if ($row->profile_pic == '') {
      $profile_picture = "<img src='../bank_admin/dist/img/user_icon.png' class=' elevation-2' alt='User Image'>
                ";
    } else {
      $profile_picture = "<img src='../bank_admin/dist/img/$row->profile_pic' class='elevation-2' alt='User Image'>
                ";
    }
  ...
  ?>
      ...
      <a href="pages_dashboard.php" class="brand-link">
        <img src="../bank_admin/dist/img/<?php echo $sys->sys_logo;?>" alt="iBanking Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
