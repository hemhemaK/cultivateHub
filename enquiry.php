...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;"><b>Facing Problem Contact Us</b></h3>
...
<b>Description</b>  <textarea name="description" class="form-control" rows="6" cols="50" id="description"  placeholder="Description" required=""></textarea> 
			...
			<p style="width: 350px;">
<button type="submit" name="submit1" class="btn-primary btn"><b>Submit</b></button>
			</p>
			</form>
