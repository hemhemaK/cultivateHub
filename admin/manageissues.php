...
<html>
<head>
<title>| Cultivate-HUB | Admin manage Issues</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="http://localhost/cultivate/admin/dashboard.php"><b>Home</a><i class="fa fa-angle-right"></i>Manage Issues</b></li>
            </ol>
