...
<html>
<head>
<title>| Cultivate-HUB | Admin Change Password</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="http://localhost/cultivate/admin/dashboard.php"><b>Home</a><i class="fa fa-angle-right"></i>Change Password</b></li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
