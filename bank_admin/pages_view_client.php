                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_manage_clients.php">Banking Clients</a></li>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-purple card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <p class="text-muted text-center">Client @Banking </p>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="update_Profile">
                                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputName2" class="col-sm-2 col-form-label">ID Number</label>
                                                        <div class="col-sm-10">
