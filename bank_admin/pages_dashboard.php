      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
			  ...
			  <span class="info-box-icon bg-info elevation-1">
               <a href="http://localhost/InternetBanking/admin/pages_manage_clients.php"><i class="fas fa-users"></i></span></a>
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><a href="http://localhost/InternetBanking/admin/pages_manage_staff.php"><i class="fas fa-user-tie"></i></span></a>
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-success elevation-1"><a href="http://localhost/InternetBanking/admin/pages_manage_accs.php"><i class="fas fa-briefcase"></i></span></a>
                <div class="info-box-content">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-purple elevation-1"><a href="http://localhost/InternetBanking/admin/pages_manage_acc_openings.php"><i class="fas fa-users"></i></span></a>
                <div class="info-box-content">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box">
                <span class="info-box-icon bg-info elevation-1"><a href="http://localhost/InternetBanking/admin/pages_deposits.php"><i class="fas fa-upload"></i></span></a>
                <div class="info-box-content">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><a href="http://localhost/InternetBanking/admin/pages_withdrawals.php"><i class="fas fa-download"></i></span></a>
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-success elevation-1"><a href="http://localhost/InternetBanking/admin/pages_transfers.php"><i class="fas fa-random"></i></span></a>
                <div class="info-box-content">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-purple elevation-1"><a href="http://localhost/InternetBanking/admin/pages_balance_enquiries.php"><i class="fas fa-money-bill-alt"></i></span></a>
                <div class="info-box-content">
