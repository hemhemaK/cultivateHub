                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                           ...
                                           <div class=" col-md-4 form-group">
                                                    <label for="exampleInputEmail1">Client National ID</label>
                                                    <input type="text" readonly name="client_national_id" value="<?php echo $row->client_national_id; ?>" required class="form-control" id="exampleInputEmail1">
                                                </div>
                                              <div class=" col-md-4 form-group">
